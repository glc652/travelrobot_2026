...
# 设置手动白平衡
# 参数一：True自动白平衡  False手动白平衡
# 参数二：列表中三个数据白平衡增益调节，分别是调节R、G、B三个通道
sensor.set_auto_whitebal(False, [0x5d, 0x40, 0x5e])

# 设置摄像头帧率
# 参数一：帧率    可以填写2、8、15、30、50、60
