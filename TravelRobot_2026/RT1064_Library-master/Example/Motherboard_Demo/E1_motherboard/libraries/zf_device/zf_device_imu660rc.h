...
//====================================================软件 IIC 驱动====================================================
#define IMU660RC_SOFT_IIC_DELAY         ( 100 )                                 // 软件 IIC 的时钟延时周期 数值越小 IIC 通信速率越快
#define IMU660RC_SCL_PIN                ( C23 )                                 // 软件 IIC SCL 引脚 连接 IMU660RC 的 SCL 引脚
#define IMU660RC_SDA_PIN                ( C22 )                                 // 软件 IIC SDA 引脚 连接 IMU660RC 的 SDA 引脚
//====================================================软件 IIC 驱动====================================================
#else

//====================================================硬件 SPI 驱动====================================================
#define IMU660RC_SPI_SPEED              (10 * 1000 * 1000)                      // 硬件 SPI 速率
#define IMU660RC_SPI                    (SPI_4)                                 // 硬件 SPI 号
#define IMU660RC_SPC_PIN                (SPI4_SCK_C23 )                         // 硬件 SPI SCK 引脚
#define IMU660RC_SDI_PIN                (SPI4_MOSI_C22)                         // 硬件 SPI MOSI 引脚
#define IMU660RC_SDO_PIN                (SPI4_MISO_C21)                         // 硬件 SPI MISO 引脚
//====================================================硬件 SPI 驱动====================================================
#endif
#define IMU660RC_CS_PIN                 ( C20 )                                 // CS 片选引脚
#define IMU660RC_CS(x)                  ( (x) ? (gpio_high(IMU660RC_CS_PIN)) : (gpio_low(IMU660RC_CS_PIN)) )
#define IMU660RC_INT2_PIN               ( D1 )                                 // 中断信号引脚，在读取四元数时需要使用
