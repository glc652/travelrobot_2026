...
// 
// 4.通过逐飞助手上位机打开ch9141 USB端的串口  串口波特率为 zf_device_bluetooth_ch9141.h 文件中 BLUETOOTH_CH9141_BUAD_RATE 宏定义 默认 115200，核心板按下复位按键
// 
...
// 
// 问题1：串口没有数据
//      查看逐飞助手上位机打开的是否是正确的串口，检查打开的 COM 口是否对应的是 ch9141 的 COM 口
