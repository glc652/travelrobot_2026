...
// 接入正交编码器连接 1
//      模块管脚            单片机管脚
//      A                   ENCODER_1_A 宏定义的引脚 默认 C0
//      B                   ENCODER_1_B 宏定义的引脚 默认 C1
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
// 
// 接入正交编码器连接 2
//      模块管脚            单片机管脚
//      A                   ENCODER_2_A 宏定义的引脚 默认 C2
//      B                   ENCODER_2_B 宏定义的引脚 默认 C24
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
// 接入正交编码器连接 3
//      模块管脚            单片机管脚
//      A                   ENCODER_3_A 宏定义的引脚 默认 C3
//      B                   ENCODER_3_B 宏定义的引脚 默认 C4
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
// 
// 接入正交编码器连接 4
//      模块管脚            单片机管脚
//      A                   ENCODER_4_A 宏定义的引脚 默认 C5
//      B                   ENCODER_5_B 宏定义的引脚 默认 C25
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源


// *************************** 例程测试说明 ***************************
// 1.核心板烧录本例程 插在主板上 四个正交编码器连接到主板的编码器接口
// 
