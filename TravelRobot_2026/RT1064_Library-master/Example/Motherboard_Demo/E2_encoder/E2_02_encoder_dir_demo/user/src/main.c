...
// 接入方向编码器连接 1
//      模块管脚            单片机管脚
//      LSB                 ENCODER_1_LSB 宏定义的引脚 默认 C0
//      DIR                 ENCODER_1_DIR 宏定义的引脚 默认 C1
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
// 
// 接入方向编码器连接 2
//      模块管脚            单片机管脚
//      LSB                 ENCODER_2_LSB 宏定义的引脚 默认 C2
//      DIR                 ENCODER_2_DIR 宏定义的引脚 默认 C24
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源
// 接入方向编码器连接 3
//      模块管脚            单片机管脚
//      LSB                 ENCODER_3_LSB 宏定义的引脚 默认 C3
//      DIR                 ENCODER_3_DIR 宏定义的引脚 默认 C4
//      GND                 核心板电源地 GND                
//      3V3                 核心板 3V3 电源                 
//                                                           
// 接入方向编码器连接 4                                       
//      模块管脚            单片机管脚                        
//      LSB                 ENCODER_4_LSB 宏定义的引脚 默认 C5
//      DIR                 ENCODER_4_DIR 宏定义的引脚 默认 C25
//      GND                 核心板电源地 GND
//      3V3                 核心板 3V3 电源

// *************************** 例程测试说明 ***************************
// 1.核心板烧录本例程 插在主板上 四个方向编码器连接到主板的编码器接口
// 
