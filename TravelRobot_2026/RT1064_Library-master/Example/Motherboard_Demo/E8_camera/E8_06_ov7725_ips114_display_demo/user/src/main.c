...
int main(void)
{
    ...
    ips114_init();
    ips114_show_string(0, 0, "ov7725 init.");
    while(1)
    {
        if(ov7725_init())
            ips114_show_string(0, 16, "ov7725 reinit.");
        else
            break;
    ...
    while(1)
    {
        ...
        {
            ips114_displayimage7725((const uint8 *)ov7725_image_binary, 240, 135);
//            ips114_show_binary_image(0, 0, (const uint8 *)ov7725_image_binary, OV7725_W, OV7725_H, 240, 135);
