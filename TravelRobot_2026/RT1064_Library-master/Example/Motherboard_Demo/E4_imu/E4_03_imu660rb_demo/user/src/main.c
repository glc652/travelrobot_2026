...
// 接入 IMU660RB
//      模块管脚            单片机管脚
//      SCL/SPC             查看 zf_device_imu660rb.h 中 IMU660RB_SPC_PIN 宏定义 默认 C23 
//      SDA/DSI             查看 zf_device_imu660rb.h 中 IMU660RB_SDI_PIN 宏定义 默认 C22
//      SA0/SDO             查看 zf_device_imu660rb.h 中 IMU660RB_SDO_PIN 宏定义 默认 C21
//      CS                  查看 zf_device_imu660rb.h 中 IMU660RB_CS_PIN 宏定义 默认 C20
//      GND                 电源地 GND
//      3V3                 电源 3V3
...
// *************************** 例程测试说明 ***************************
// 1.核心板烧录完成本例程，单独使用核心板与调试下载器或者 USB-TTL 模块，并连接好 IMU660RB 模块，在断电情况下完成连接
// 
